...
// COMMENTED OUT: AWS SDK functionality removed
...
func BucketExists(ctx context.Context, s3cli interface{}, URI archiver.URI) error {
	return fmt.Errorf("AWS SDK functionality has been disabled - aws-sdk-go dependency removed")
}

func KeyExists(ctx context.Context, s3cli interface{}, URI archiver.URI, key string) (bool, error) {
	return false, fmt.Errorf("AWS SDK functionality has been disabled - aws-sdk-go dependency removed")
}
...
func Upload(ctx context.Context, s3cli interface{}, URI archiver.URI, key string, data []byte) error {
	return fmt.Errorf("AWS SDK functionality has been disabled - aws-sdk-go dependency removed")
}

func Download(ctx context.Context, s3cli interface{}, URI archiver.URI, key string) ([]byte, error) {
	return nil, fmt.Errorf("AWS SDK functionality has been disabled - aws-sdk-go dependency removed")
}
